 ...
 */
@Table(name ="user_code_collection_relation")
@Data
public class UserCodeCollectionRelation implements Serializable {
    /**
     * 
     */
    ...
    public boolean equals(Object that) {
        ...
        UserCodeCollectionRelation other = (UserCodeCollectionRelation) that;
